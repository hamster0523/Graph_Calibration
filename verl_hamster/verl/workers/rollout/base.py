...
__all__ = ["BaseRollout", "NoOpRolloutMixin"]

class NoOpRolloutMixin:
    def update_weights(self, state_dict: Optional[dict] = None, *args, **kwargs):
        return None
...
_ROLLOUT_REGISTRY = {
    ("naive_hamster", "sync"): "verl.workers.rollout.naive.naive_hamster_rollout.NaiveHamsterRollout",
    ("vllm_hamster", "sync"): "verl.workers.rollout.vllm_rollout.vllm_hamster_rollout.vLLMHamsterRollout",
