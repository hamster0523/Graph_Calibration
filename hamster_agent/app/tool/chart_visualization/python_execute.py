...
6. Make sure to import all necessary libraries in your code. For example, if your code uses pandas, numpy, or matplotlib, include the appropriate import statements at the beginning of your script.""".format(
    ...
    async def execute(self, code: str, code_type: str | None = None, timeout=1000):
